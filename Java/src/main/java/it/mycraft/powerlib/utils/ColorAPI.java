...
public class ColorAPI {
    ...
    public static List<String> color(List<String> list) {
        return list.stream().map(it.mycraft.powerlib.common.utils.ColorAPI::color).collect(Collectors.toList());
    }
    ...
    public static List<String> decolor(List<String> list) {
        return list.stream().map(it.mycraft.powerlib.common.utils.ColorAPI::decolor).collect(Collectors.toList());
    }
}
